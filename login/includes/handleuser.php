...
if($role == 2){
    if(isset($_POST['updateUser'])){
        ...
        if ($error == 0){
            $query = "UPDATE user SET firstname='$firstname', lastname='$lastname', phone='$phone',email='$email', user_level='$level' WHERE id='$id'";
